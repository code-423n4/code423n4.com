...
**[cemozerr (Judge) commented](https://github.com/code-423n4/2021-05-nftx-findings/issues/46#issuecomment-848259748):**
...
**[cemozerr (Judge) commented](https://github.com/code-423n4/2021-05-nftx-findings/issues/56#issuecomment-848266608):**
...
**[cemozerr (Judge) commented](https://github.com/code-423n4/2021-05-nftx-findings/issues/88#issuecomment-848325710):**
...
In this way, the `directReedemFee` can be avoided and users may lose out on potential earnings. Recommend transfer ownership of ERC20 tokens to attack contract.
```
...
**[cemozerr (Judge) commented](https://github.com/code-423n4/2021-05-nftx-findings/issues/71#issuecomment-848321831):**
...
**- [cemozerr (Judge) commented](https://github.com/code-423n4/2021-05-nftx-findings/issues/54#issuecomment-848263863):**
...
**[cemozerr (Judge) commented](https://github.com/code-423n4/2021-05-nftx-findings/issues/52#issuecomment-848262690):**
...
<!-- ❓@eric some of the issue headers are missing their issue number like this one which I just went ahead and labeled 13. Issue with submission aggregating script? -->
<!-- 👨‍🦳 could be, yeah, might need to look at that. the numbering is off though above, it goes from 9 -> 12. -->

**- [0xKiwi (NFTX) disputed](https://github.com/code-423n4/2021-05-nftx-findings/issues/100)**

**[cemozerr (Judge) commented](https://github.com/code-423n4/2021-05-nftx-findings/issues/100#issuecomment-848300810):**
