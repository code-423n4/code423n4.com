...
**Jack the Pug (judge) commented:**
 > This depends on how the `VERSION()` method is going to be used. As it's inherited from `IProject`, it's probably required by the front-end, thus, I agree that this one is more likely to be invalid.
